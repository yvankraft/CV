...
const About = () => {
  return (
    <div className="min-h-screen max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5">
      <div className="relative md:col-span-2 lg:col-span-1 flex justify-center items-center order-2 md:order-1">
        <Navbar />
      </div>
      <div className="order-1 md:order-2 md:col-span-4 lg:col-span-4 w-full min-h-screen md:h-[95vh] flex flex-col gap-4 justify-center items-center p-4 sm:p-6 pb-20 md:pb-4">
        <div className="grid grid-cols-1 lg:grid-cols-6 h-full w-full gap-4 max-w-6xl">
          <motion.div
            initial={{ x: -200, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.8 }}
            className="bg-slate-50/90 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-xl lg:col-span-4 border border-slate-200"
          >
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-700 mb-6">Skills</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h2 className="text-lg sm:text-xl font-semibold text-slate-600">Frontend</h2>
                <ProgressBar
                  skill="HTML/CSS"
                  percentage={90}
